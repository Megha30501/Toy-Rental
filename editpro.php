            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 margin-bottom-80 text-center paira-margin-top-1">
                        ...
                        <h3 class="text-uppercase raleway-light margin-clear paira-padding-bottom-2">Edit Profile</h3>
                    </div>
                               <?php 
                            require 'dbconnect.php';
                            //$id=$_GET['id'];
                            $qry="SELECT * FROM user where id=$u_id";
                    ...
                    <div class=" col-md-12 col-sm-12 col-xs-12 paira-animation animated fadeInUp" data-paira-animation="fadeInUp" data-paira-animation-delay=".5s">
                        <div class="form-contact">
                            <form accept-charset="UTF-8" action="editprocess.php" class="contact-form" method="post">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input name="form_type" type="hidden" value="new_comment">
                                    <input name="id" type="hidden" value="<?php echo $row['id'];?>">
                                    <input type="text"  class="form-control margin-bottom-30" placeholder="User name" name="user_name" value="<?php echo $row['user_name'];?>">
                                    <input type="email" class="form-control margin-bottom-30" placeholder="Email" name="user_email" value="<?php echo $row['email'];?>">
                                     <input type="text" class="form-control margin-bottom-30" placeholder="Password" name="pwd" value="<?php echo $row['password'];?>">
                                   

                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                     <textarea  name="address"  class="form-control margin-bottom-30" rows="3" cols="3" value="" placeholder="Address"><?php echo $row['address'];?></textarea>
                                    <input type="text" pattern="[0-9]{10}" class="form-control margin-bottom-30" placeholder="Phone no" name="phone_no" value="<?php echo $row['mobile_no'];?>">
                                     
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 paira-margin-bottom-2">
                                    <button type="submit" name="btn_sb"class="btn btn-success btn-lg pull-right text-uppercase" class="btn_enter" value="Send">Update Profile</button>
                                </div>
