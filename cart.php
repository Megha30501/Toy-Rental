                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 table-responsive margin-bottom-20 cart-item-list  paira-animation animated fadeInUp" data-paira-animation="fadeInUp" data-paira-animation-delay="0.5s" tabindex="0" style="overflow: hidden; outline: none;">
                        <div class="pro-detail">
                            <h4 class="text-uppercase rale-light">product</h4>
                        </div>
                        ...
                        <table class="table">
                            ...
                            <tr class="paira-product">
                                <?php
                                                    $toyid= $row['product_id'];
                                                    
                                            $select_book="SELECT * FROM product WHERE id=$toyid";
                                ...
                                <td class="row-2s">
                                    <a href="product.php" class="font-size-14 rale-light font-bold prod-name text-capitalize margin-bottom-10"><?php echo $row_book['product_name'];?></a>
                                    <input type="hidden" name="id" value="<?php echo $row_book['id'];?>">
                                </td>
                                <td class="row-3s">
                                    <h4 class="margin-top-5 text-center"><span class="money rale-light font-bold font-size-14"><?php echo $row_book['price'];?></span></h4>
                                </td>
                                <td class="text-center row-4s">
                                    <div class="quantity">
                                        <form action="upadate_qua.php" method="post">
                                       <input type="text" name="qua" style="width: 50px;" placeholder="insert quantity" value="<?php echo $row['quantity'];?>"> 
                                       <input type="hidden" name="p_id" value="<?php echo $row['id'];?>">
                               <input type="submit" name="submit" value="update" class="btn btn-info"></form>
                                      <!--   <button class="pull-left btn right-bt" data-direction="down"><i class="fa fa-angle-down font-size-18"></i></button>
                                        <input type="text" value="1" class="pull-left rale-light text-center product_quantity_text">
                                        <button class="btn left-bt" data-direction="up"><i class="fa fa-angle-up font-size-18"></i></button> -->
                                    </div>
                                </td>
                                <td class="row-3s">
                                    <h4 class="margin-top-5 text-center"><span class="money rale-light font-bold font-size-14"><?php echo $row_book['price']*$row['quantity'];?></span></h4>
                                </td>
                                <td>
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12 text-right update-continue">
                            ...
                            <a href="order.php" class="btn btn-default btn-lg check-out text-uppercase margin-top-30">Checkout </a>
